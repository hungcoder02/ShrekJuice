...
//========================================================
    function insert_product($product){
        ...
        $sql .= "'" . $product['name'] . "', ";
        $sql .= "'" . $product['price'] . "', ";
        $sql .= '"' . htmlspecialchars($product['detail']) . '", ';
        $sql .= "'" . $product['picture'] . "'";
        $sql .= ")";
    ...
    function update_product($product) {
        ...
        $sql .= 'detail="' . htmlspecialchars($product['detail']) . '", ';
...
// =====================================================================admin
    ...
    function change_Password($new_password, $username){
        global $db;

        $sql = "UPDATE admin set ";
        $sql .= "pass='" . $new_password . "' ";
        $sql .= "WHERE username='" . $username . "';";
        $result = mysqli_query($db, $sql);
        return confirm_query_result($result);
    }
...
// ----------------------------------count
    function count_category(){
        ...
        $result = mysqli_query($db, "SELECT count(categoryID) as total from category");
    ...
    function count_product(){
        ...
        $result = mysqli_query($db, "SELECT count(productID) as total from product");
        $data = mysqli_fetch_assoc($result);
        echo $data['total'];
    }
    function count_admin(){
        ...
        $result = mysqli_query($db, "SELECT count(username) as total from admin");
        $data = mysqli_fetch_assoc($result);
        echo $data['total'];
    }
?>
